    ...
    namespace :v2 do
      ...
      scope "user" do
        ...
        scope "langganan" do
          ...
          get "jam-jemput",     to: "user_langganan#jam_jemput"
          get "alamat-jemput",  to: "user_langganan#alamat_jemput"
          post "order",         to: "user_langganan#order_jemput"
          get "order/:uuid",    to: "user_langganan#detail"
          post "order-send",    to: "user_langganan#order_send"
          post "order-cancel",  to: "user_langganan#order_cancel"
        end
